               ...
               pf_init_model_fn_t random_pose_fn, void *random_pose_data)
{
  ...
  pf->w_slow = 0.0;//长期似然平均
  pf->w_fast = 0.0;//短期似然平均
...
void pf_update_resample(pf_t *pf)
{
  ...
  set_b->sample_count = 0;
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //当系统出现机器人绑架等问题时，粒子的平均权重会开始下降，此时随着机器人的运动与粒子不断的测量更新，粒子平均权重将会保持在一个低位。
  //从而导致 pf->w_slow 的值会大于 pf->w_fast ,使得 0 < pf->w_fast/pf->w_slow < 1
  //此时粒子滤波器将会按照 max(0.0, 1.0 - pf->w_fast / pf->w_slow)的概率往粒子集里面注入随机粒子。
  //当系统对自己的位置十分肯定后 pf->w_fast > pf->w_slow ，此时随机粒子不再添加，而是从原先的粒子集中筛选权重较大的.
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
