...
def add_generic_localplanner_params(gen):
    ...
    gen.add("xy_goal_tolerance_for_rotation", double_t, 0, "Within what maximum distance we consider the robot to be in goal when rotation", 0.1)
    gen.add("xy_goal_tolerance_for_charging", double_t, 0, "Within what maximum distance we consider the robot to be in goal when charging", 0.1)
